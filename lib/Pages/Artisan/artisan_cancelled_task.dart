...
class ArtisanCancelledTask extends StatefulWidget {
  const ArtisanCancelledTask({super.key});

  @override
  State<ArtisanCancelledTask> createState() => _ArtisanCancelledTaskState();
}

class _ArtisanCancelledTaskState extends State<ArtisanCancelledTask> {
